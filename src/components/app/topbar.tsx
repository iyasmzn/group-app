          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem asChild>
                <Link href="/app/profile" className="block px-4 py-2 text-sm hover:bg-secondary">
                  Profile
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
      ...
      <header className="sticky top-0 left-0 right-0 z-50 border-b bg-background px-4 py-3">
        <div className="flex items-center justify-between mx-auto">
          <div className="flex items-center flex-1">
            ...
            {backButton && !backHref ? <BackButton /> : null}
            {backHref && (
            ...
            {titleSlot ? (
              ...
              <div className="flex-1 flex gap-2 truncate">
                ...
                <h1 className="text-base font-semibold truncate">{title || getDefaultTitle()}</h1>
              </div>
            )}
          </div>
