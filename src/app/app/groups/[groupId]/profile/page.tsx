    ...
    <>
      <div className="flex flex-col pb-10 px-2 md:px-6">
        ...
        <div className="flex flex-col items-center py-8">
          ...
          <div>
            {groupNameEdit ? (
              ...
              <Skeleton className="w-40 h-8 mt-2"></Skeleton>
            ) : (
              <Reveal animation="fadeIn" key={'group_name_key'}>
                <h1 className="mt-4 text-2xl font-bold flex items-center gap-2">
                  ...
                  <Edit3
                    ...
                    className="text-secondary-foreground w-4 h-4 cursor-pointer"
                  />
                </h1>
              </Reveal>
            )}
        ...
        <div className="grid grid-cols-4 justify-center gap-4 mb-4">
          <button
            onClick={handleBack}
            className="flex flex-col py-2 px-3 rounded-xl items-center border border-secondary hover:bg-secondary transition-all"
          >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">
                      {m.profiles?.full_name == user?.user_metadata?.full_name
                        ? 'You'
                        : m.profiles?.full_name}
                    </p>
        ...
        {group?.group_members?.some(
          (m) => m.group_roles?.code === 'owner' && m.profiles?.id === user?.id
        ) && (
